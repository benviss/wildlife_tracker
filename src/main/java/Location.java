...
//     try(Connection con = DB.sql2o.open()) {
//       con.createQuery("DELETE FROM locations *")
//       .executeUpdate();
//     }
//   }
//
//   public static Integer getLocationId(int _animalId) {
//     try(Connection con = DB.sql2o.open()) {
//       return con.createQuery("SELECT location_id FROM animal_sightings WHERE animal_id=:_animalId")
